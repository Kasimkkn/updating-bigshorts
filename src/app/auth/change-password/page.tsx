...
const ChangePassword = () => {
    ...
    const [optId] = useLocalStorage<string>('otpId', '');
    ...
    const [validInput, setValidInput] = useState({ password: false, confirmPassword: false });
    ...
    const handleChange = (e: ChangeEvent<HTMLInputElement>) => {
        ...
        setValidInput({ password: false, confirmPassword: false });
    };
