...
const SeriesVideoModal = ({ flix: initialFlix, setSingleFlixDataModel, showMobileComments, setShowMobileComments }: {
    flix: PostlistItem,
    ...
    //                 // Set flix entirely from the API response
    //                 setFlix(detailedFlix);
    //                 setSingleFlixDataModel(detailedFlix);
    //             } else {
    ...
    // Load comments when flix data changes
    useEffect(() => {
        if (flix?.postId) {
            getCommentsData();
        }
        ...
        <>
            <div className="w-full h-full flex flex-col">
                ...
                <div className="flex-shrink-0">
                    ...
                    <div className="py-4 md:p-4 bg-bg-color text-text-color relative border-b border-b-border-color">
                        ...
                        <div className="flex justify-between items-center max-md:flex-col">
                            <div className="max-md:order-2 flex md:items-center gap-4 mt-4 max-md:w-full max-md:justify-between">
                                <button
                                    onClick={() => {
                                ...
                                >
                                    ...
                                    <div className="flex flex-col max-sm:max-w-[100px]">
                                        <h2 className="font-semibold truncate">
                                            {flix.userFullName}
                                        </h2>
                                        <p className="text-start text-sm truncate">{flix.userName ? `@${flix.userName}` : '\u00A0'}</p>
                                    </div>
                                </button>
                                <FollowButton requestId={flix.userId} isFollowing={flix.isFriend} />
                            </div>

                            <div className="max-md:order-1 flex md:items-center gap-2 mt-4 max-md:w-full max-md:justify-between">
                                <button
                            ...
                            <div className="mt-4 space-y-4">
                                {commentsData.map((data, index) => (
                                    <div key={index + 1} className="flex flex-col p-2 rounded-lg bg-primary-bg-color mb-2">
                                        ...
                                        {openReportModal?.commentId === data.commentId && <ReportModal postId={flix.postId} replyId={openReportModal.replyId} commentId={data.commentId} onClose={() => { setOpenReportModal(null) }} isFlix={true} />}
                                    </div>
                                ))}
...
export default SeriesVideoModal;