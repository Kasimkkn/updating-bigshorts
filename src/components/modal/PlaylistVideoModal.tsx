...
const PlaylistVideoModal = ({ flix: initialFlix, setSingleFlixDataModel, isCommentModalOpen, setIsCommentModalOpen }: {
    flix: PostlistItem,
    ...
    return (
        <>
            <div className="w-full h-full flex flex-col">
                        ...
                        <div className="flex max-md:flex-col justify-between items-center w-full">
                            ...
                            <div className="max-md:order-1 flex md:items-center gap-2 mt-4 max-md:w-full max-md:justify-between">
                                ...
                                <button onClick={handleShareVideo} className="flex items-center gap-2 text-primary-text-color">
                                    <PiPaperPlaneTilt /> <span className="max-md:hidden">Share</span>
                                </button>
                                <span className="md:hidden flex items-center gap-2 text-primary-text-color">
                                    <FaEye />
                                    {flix.viewCounts} Views
                                </span>
                                <button className="flex items-center gap-2 text-primary-text-color md:hidden">
                                    {!flix.isSaved ? <FaRegBookmark /> : <FaBookmark />}
                                    <p className="hidden md:block">Save</p>
                                </button>
                            </div>
                ...
                <div className="max-md:hidden flex-grow overflow-y-auto">
                                ...
                                {commentsData.map((data, index) => (
                                    <div key={index + 1} className="flex flex-col p-2 rounded-lg bg-primary-bg-color mb-2">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            >
                                                {data.isCommentLiked ? (
                                                    <AiFillLike size={20} color="red" fill="red" />
                                                ) : (
